...
__decorate([
    ...
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
], CreateWalletDto.prototype, "ownerName", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ enum: wallet_entity_1.Currency, default: wallet_entity_1.Currency.USD }),
    (0, class_validator_1.IsEnum)(wallet_entity_1.Currency),
