...
export class PayrollProcessor extends WorkerHost {
     ...
     */
    async process(job: Job<{ dto: BulkPayrollDto; jobId: string }>): Promise<any> {
        ...
        dbJob.status = processedCount === dbJob.totalEmployees ? PayrollJobStatus.COMPLETED : PayrollJobStatus.FAILED;
        dbJob.processedEmployees = processedCount;
        await this.jobRepo.save(dbJob);
