...
export class TransactionController {
  ...
  @ApiOperation({
    ...
    description:
      'Ensures exactly-once processing even on client retries or simultaneous crashes. Applies locked FX rate if quoteId provided.',
  })
  ...
  @Get('recovery')
  @ApiOperation({
    summary: 'Trigger crash recovery scan manually (for testing Scenario C)',
  })
  recover() {
