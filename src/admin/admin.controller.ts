...
export class AdminController {
    ...
    @Get('wallets')
    @ApiOperation({ summary: 'Internal view of all user wallets and snaphost balances' })
    listSysWallets() {
    ...
    @Get('audit/wallet/:id')
    @ApiParam({ name: 'id' })
    @ApiOperation({ summary: 'Verify tamper-evident hash chain for a specific wallet' })
